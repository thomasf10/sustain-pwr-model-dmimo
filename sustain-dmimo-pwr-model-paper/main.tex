...
\title{A Power Model for D-MIMO Systems: Comparing the Energy Consumption of D-MIMO and Co-located MIMO\\
...
\thanks{todo add sustain ack
}
}

% }
\author{\IEEEauthorblockN{Thomas Feys, François Rottenberg
	}
...
\input{sections/sysmodel}
\input{sections/pwr_model.tex}
\input{sections/numerical_eval.tex}
